...
public class SessionData : NetworkBehaviour {
    ...
    internal NetworkVariable<bool> extendedMineTest = new NetworkVariable<bool>(true);
    public static bool ExtendedMineTest => instance?.extendedMineTest?.Value ?? Plugin.ExtendedMineTest;
